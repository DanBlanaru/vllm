...
def time_cuda_us(fn, warmup=10, trials=50):
...
def run_benchmark(args):
    ...
    # Pre-compute Q/K/V for isolated component benchmarks
    with torch.no_grad():
    ...
    # --- Measure ---
    if rank == 0:
        print(f"  Running {args.trials} trials per component...\n")
    ...
    if rank == 0:
        ...
        dp0_max = max(all_results[t]["total"][0]
